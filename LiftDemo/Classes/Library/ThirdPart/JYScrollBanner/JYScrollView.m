...
- (void)bannerWithArray:(NSArray *)array titleArr:(NSArray *)titleArr imageType:(JYImageType)type placeHolder:(NSString *)placeHold tapAction:(void(^)(NSInteger index))sel {
    NSMutableArray * tempArray = [NSMutableArray array];
...
- (void)setDatas:(NSArray *)datas
{
    ...
    if (count > 0)
    {
        ...
        if (count > 1)
        {
            ...
            SLLog(self.scrollView.contentSize);
