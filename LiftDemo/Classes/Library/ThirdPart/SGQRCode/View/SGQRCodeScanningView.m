...
- (void)addTimer {
    ...
    self.timer = [NSTimer scheduledTimerWithTimeInterval:SGQRCodeScanningLineAnimation target:[YYTextWeakProxy proxyWithTarget:self] selector:@selector(timeAction) userInfo:nil repeats:YES];
