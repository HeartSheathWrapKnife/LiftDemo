...
#import "JYStarRateView.h"

#define FOREGROUND_STAR_IMAGE_NAME @"b27_icon_star_yellow"  //亮星星图片
#define BACKGROUND_STAR_IMAGE_NAME @"b27_icon_star_gray"    //灰星星图片
#define DEFALUT_STAR_NUMBER 5                               //默认星星总数量,默认5
#define ANIMATION_TIME_INTERVAL 0.2

@interface JYStarRateView ()
...
- (void)layoutSubviews {
    ...
    __weak JYStarRateView *weakSelf = self;
