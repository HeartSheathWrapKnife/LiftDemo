...
+ (NSInteger)getFirstWeekdayWithYear:(NSInteger)year month:(NSInteger)month {
    ...
    [gregorian components:(NSCalendarUnitDay | NSCalendarUnitMonth | NSCalendarUnitYear | NSCalendarUnitWeekday) fromDate:date];
...
+ (NSComparisonResult)compareWithComponentsOne:(NSDateComponents *)componentsOne
    ...
    if (componentsOne.year == componentsTwo.year && componentsOne.month == componentsTwo.month &&
...
+ (NSMutableArray *)arrayComponentsWithComponentsOne:(NSDateComponents *)componentsOne
    ...
    NSString *stringOne = [NSString stringWithFormat:@"%zd-%zd-%zd", componentsOne.year, componentsOne.month, componentsOne.day];
    NSString *stringTwo = [NSString stringWithFormat:@"%zd-%zd-%zd", componentsTwo.year, componentsTwo.month, componentsTwo.day];
