...
@interface MirrorController ()<UIGestureRecognizerDelegate>
// 拍照图像展示层
...
{
    AVCaptureDeviceDiscoverySession *device =[AVCaptureDeviceDiscoverySession discoverySessionWithDeviceTypes:@[AVCaptureDeviceTypeBuiltInWideAngleCamera] mediaType:AVMediaTypeVideo position:position];
    NSArray *devices = device.devices;
...
- (UIView *)backSliderView
{
    ...
    UIView *backView = [[UIView alloc] initWithFrame:CGRectMake(0, kScreenHeight-30, kScreenWidth, 20)];
    // 滑动条slider
    _slider = [[UISlider alloc] initWithFrame:CGRectMake(30, 0, kScreenWidth-60, 20)];
