...
@property (nonatomic, strong) CompassManage *manager;
...
//    UILabel *tipLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, kScreenHeight-50, kScreenWidth, 20)];
